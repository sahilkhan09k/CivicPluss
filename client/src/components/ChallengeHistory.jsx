        ...
        <div className="space-y-6">
            ...
            {stats && (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="card">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-600">Overturn Rate</p>
            ...
            <div className="card">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        >
                            <option value="">All Resolved Challenges</option>
                            <option value="me">My Resolved Challenges</option>
            ...
            <div className="card overflow-hidden">
                <h3 className="text-lg font-semibold mb-4 px-6 pt-6">
                    {filters.reviewedBy === 'all' ? 'All Challenges' : 
                     filters.reviewedBy === 'me' ? 'My Resolved Challenges' : 
                     'All Resolved Challenges'}
                </h3>
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead className="bg-gray-50 border-b">
                                ...
                                <tr key={challenge._id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                                        {challenge.reviewDecision ? (
                                            <span className={`font-medium ${
                                                challenge.reviewDecision === 'admin_wrong' ? 'text-red-600' : 'text-green-600'
                                            }`}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        {challenge.reviewedAt ? (
                                            new Date(challenge.reviewedAt).toLocaleDateString()
                                        ) : (
                                            <span className="text-gray-400">-</span>
                                        )}
                                    </td>
